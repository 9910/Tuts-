...
public class Pravougaonik extends Kvadrat{
	...
	public Pravougaonik(Tacka goreLevo, int visina, int sirina, Color bojaIvice, Color bojaUnutrasnjosti, int index){
		this(goreLevo, visina, sirina);
		setPvIvice(bojaIvice);
		setPvUnutrasnjost(bojaUnutrasnjosti);
		this.index = index;
	}
