...
public class Kvadrat extends PovrsinskiOblik implements Pomerljiv{
	...
	public Kvadrat(Tacka goreLevo, int duzinaStranice, Color bojaIvice, Color bojaUnutrasnjosti, int index){
		this.goreLevo = goreLevo;
		this.duzinaStranice = duzinaStranice;
		setColor(bojaIvice);
	...
	public Color getBojaUnutrasnjosti2() {
		return bojaUnutrasnjosti;
	}
	public void setBojaUnutrasnjosti2(Color bojaUnutrasnjosti) {
